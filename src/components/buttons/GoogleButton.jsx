...
export const GoogleButton = ({ authType }) => {
  return (
    <React.Fragment>
      {/* SIGN UP */}
      {authType === "signup" && (
        <button
          className='flex items-center justify-center w-full px-4 py-2 mb-5 text-sm font-bold text-black border rounded dark:bg-gray-100 focus:outline-none focus:shadow-outline'
          type='button'
        >
          <svg
